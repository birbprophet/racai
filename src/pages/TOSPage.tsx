...
const Page = () => {
  return (
    <>
      <p>Website standard terms and conditions</p>
      <p>
        ...
        this “Website”). These Terms apply in full force and effect to your use
      ...
      <p>
        ...
        at least 18 years of age), and you must not use this Website if you a
        minor.
      </p>
      <p>
        2. Intellectual Property Rights Other than content you own, which you
        may have opted to include on this Website, under these Terms, Racai
        ...
        provided in these Terms, for purposes of viewing the material contained
        on this Website.
      </p>
      <p>
        3. Restrictions You are expressly and emphatically restricted from all
        of the following: publishing any Website material in any media; selling,
        ...
        this Website contrary to applicable laws and regulations, or in a way
        that causes, or may cause, harm to the Website, or to any person or
        business entity; engaging in any data mining, data harvesting, data
        extracting or any other similar activity in relation to this Website, or
        while using this Website; using this Website to engage in any
        advertising or marketing; Certain areas of this Website are restricted
        from access by you and Racai may further restrict access by you to any
      ...
      <p>
        ...
        choose to display on this Website. With respect to Your Content, by
        displaying it, you grant Racai a non-exclusive, worldwide, irrevocable,
      ...
      <p>
        ...
        party’s rights. Racai reserves the right to remove any of Your Content
        from this Website at any time, and for any reason, without notice.
      </p>
      <p>
        5. No warranties This Website is provided “as is,” with all faults, and
        Racai makes no express or implied representations or warranties, of any
      ...
      <p>
        6. Limitation of liability In no event shall Racai , nor any of its
        ...
        such liability is under contract, tort or otherwise, and Racai ,
      ...
      <p>
        7. Indemnification You hereby indemnify to the fullest extent Racai from
      ...
      <p>
        ...
        unenforceable or invalid under any applicable law, such unenforceability
        or invalidity shall not render these Terms unenforceable or invalid as a
        whole, and such provisions shall be deleted without affecting the
        remaining provisions herein.
      </p>
      <p>
        9. Variation of Terms Racai is permitted to revise these Terms at any
      ...
      <p>
        10. Assignment Racai shall be permitted to assign, transfer, and
      ...
      <p>
        ...
        between Racai and you in relation to your use of this Website, and
      ...
      <p>
        ...
        construed in accordance with the laws of the State of Singapore, and you
        submit to the non-exclusive jurisdiction of the state and federal courts
        located in Singapore for the resolution of any disputes.
      </p>
    </>
  );
};
